...
function AdminHome() {
  const heroCards = [
    ...
    },
    {
      ...
      career and life. All this was due to her changing her mindset - shift in her thinking,
      ...
      description: `Realising that many people were, like herself, victims of self-doubt, self-sabotage
       and self-destruction due to trauma, negative thoughts and past programming and events which have
        occurred in their lives, which often lead to destructive behaviours, depression and suicide, she
         felt she had to step up to help others.With experiences from her own life, her mum’s,
    ...
    },
    {
      ...
      cardIcon: cardIcon6,
      title: "My Motto",
      description: `Passion and commitment in all that I do.Become a progressivist in your own life.`,
    },
  ];
                    ...
                    {editingIndexTestimonial === index ? (
                      <div className="p-2">
                        ...
                        <input
                          ...
                          value={profileCard.testimonialTitle}
                          onChange={(e) =>
                            handleCardTitleChange(index, e.target.value)
                          }
                          className="form-control"
                        />
                        <input
                          ...
                          value={profileCard.testimonialDate}
                          onChange={(e) =>
                        ...
                        <input
                          ...
                          value={profileCard.testimonialDescription}
                          onChange={(e) =>
                      ...
                      <>
                        <button
                          onClick={() => setEditingIndexTestimonial(index)}
                          className="btn btn-sm link-secondary ms-2 edit-button"
                          style={{ width: "fit-content" }}
                        >
                          <FaEdit />
