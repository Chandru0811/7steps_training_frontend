            ...
            <div className="col-lg-3 col-md-6 col-12 py-2">
              ...
              <div className="footer-menu d-flex flex-column">
                <div className='d-flex'>
                 <span><FaPhone style={{fontSize:"20px"}}/> </span>
                 <span className="footer-text mx-2">(+65) 90214952</span>
                </div>
                <div className='d-flex'>
                 <span><MdEmail style={{fontSize:"25px"}}/> </span>
                 <span className="footer-text mx-2">7stepscoach.sg@gmail.com</span>
                </div>
                <div className='d-flex'>
                 <span><FaLocationDot style={{fontSize:"25px"}}/> </span>
      ...
      <div className='copyrights container-fluid'>
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center py-3">
          ...
          <div className='d-flex justify-content-center justify-content-md-end mt-3 mt-md-0'>
            <span className="mx-2" style={{ fontSize: "25px" }}><IoLogoWhatsapp /></span>
            <span className="mx-2" style={{ fontSize: "25px" }}><RiInstagramFill /></span>
            <span className="mx-2" style={{ fontSize: "22px" }}><FaLinkedin /></span>
            <span className="mx-2" style={{ fontSize: "25px" }}><RiFacebookCircleFill /></span>
            <span className="mx-2" style={{ fontSize: "25px" }}><FaYoutube /></span>
            <span className="mx-2" style={{ fontSize: "25px" }}><AiFillTikTok /></span>
          </div>
        </div>
      </div>
    </section>
